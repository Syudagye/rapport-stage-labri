...
%   \hspace{4cm}
%   \raisebox{-0.5\height}{\includegraphics[scale=1, height=0.8cm]{images/labri.png}}
%   \par
%   %\univname\par
...
\include{sections/1-presentation}
\include{sections/2-deroulement}
\include{sections/3-internationalisation}
\include{sections/4-bilan}
